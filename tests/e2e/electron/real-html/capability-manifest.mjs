...
export const CAPABILITY_MANIFEST_REASONS = Object.freeze({
  ...
  AUTHORED_DESCENDANT_OCCLUSION: "AUTHORED_DESCENDANT_OCCLUSION",
  AUTHORED_CANVAS_ROOT_NO_CAPABILITY: "AUTHORED_CANVAS_ROOT_NO_CAPABILITY",
  AUTHORED_RUNTIME_DESCENDANT_OCCLUSION: "AUTHORED_RUNTIME_DESCENDANT_OCCLUSION",
  AUTHORED_DEDICATED_SURFACE_OCCLUSION: "AUTHORED_DEDICATED_SURFACE_OCCLUSION",
  AUTHORED_MIXED_DESCENDANT_OCCLUSION: "AUTHORED_MIXED_DESCENDANT_OCCLUSION",
  AUTHORED_FOREIGN_SURFACE_OCCLUSION: "AUTHORED_FOREIGN_SURFACE_OCCLUSION",
  AUTHORED_POINTER_OCCLUSION: "AUTHORED_POINTER_OCCLUSION",
  AUTHORED_VIEWPORT_UNREACHABLE: "AUTHORED_VIEWPORT_UNREACHABLE",
});
