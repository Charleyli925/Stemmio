...
- 更多菜单在当前稿和历史页保持同一套操作顺序；不适用于当前页的操作保留但禁用，并就近说明实际作用对象。“在 Finder 中显示工作文件”和“在浏览器中打开工作文件”只作用于当前稿；历史页中两项显示为禁用，不能把当前稿误认为所见历史。纯浏览器预览没有本地文件权限，因此只展示禁用态。失败显示可恢复的全局错误，不通过顶栏重复呈现。
...
历史“导出此版本…”复制所见快照。更多菜单保留“在 Finder 中显示工作文件”和“在浏览器中打开工作文件”，但两项禁用并说明历史没有独立工作文件；隐藏快照不作为可编辑用户文件发布。
